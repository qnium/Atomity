...
//import com.qnium.common.backend.assets.interfaces.IContextEntityModifier;
 ...
 * @author Ivan
 */
public class ContextUpdateHandler implements 
    ...
    public ContextUpdateHandler(IContextValueProvider provider, String contextField) {
    ...
    public CountResponseMessage process(RequestMessage req) 
        ...
        try {
            ...
            em.selfUpdate(Arrays.asList(entity), contextField, contextValue, null, 0);
