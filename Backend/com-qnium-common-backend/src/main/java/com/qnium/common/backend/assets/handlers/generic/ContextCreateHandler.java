 ...
 * @author Ivan
 */
public class ContextCreateHandler implements 
    ...
    public ContextCreateHandler(IContextValueProvider provider, String contextField) {
    ...
    public CountResponseMessage process(RequestMessage req) 
        ...
        try {
            ...
            em.selfCreate(entity, contextField, contextValue, null, 0);
